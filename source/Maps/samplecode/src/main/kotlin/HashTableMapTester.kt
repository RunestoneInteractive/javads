fun main() {
    val table = HashTableMap<Int, String>()
    ...
    println("key 32157, value " + table.get(32157)) // Lake Como
    println("key 61820, value " + table.get(61820)) // Champaign
    println("key 95135, value " + table.get(95135)) // null

    table.put(48658, "Standish MI") // correct a misspelling
    println("key 48658, value " + table.get(48658)) // Standish
}